...
class Order(db.Model):
    ...
    def __init__(self, product, customer, date_placed, date_processed=None, download=None):
        self.product = product
        self.customer = customer
        self.date_placed = date_placed              # ✅ FIX: store actual DB field
    ...
    def date_processed_local(self):
        return self.date_processed.astimezone(local_timezone) if self.date_processed else None  # ✅ FIX
